...
package own.pixelbatterywidget;
...
public class UpdateService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_BATTERY_CHANGED.equals(action)) {
                ...
                final boolean isPluggedin = newBatteryInfo.isPluggedin(getApplicationContext());
                RemoteViews remoteViews = createRemoteViews(level, isPluggedin);
                ...
                final boolean isPluggedin = batteryInfo.isPluggedin(getApplicationContext());
                RemoteViews remoteViews = createRemoteViews(level, isPluggedin);
     ...
     * @param isPluggedin whether the battery has been charging
     * @return the RemoteViews
     */
    private RemoteViews createRemoteViews(final int level, final boolean isPluggedin) {
        ...
        */
        ...
        PendingIntent textIntent = PendingIntent.getActivity(this, 0, ownactivityIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        if(resolveInfo != null) {
                PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, powerUsageIntent, PendingIntent.FLAG_IMMUTABLE);
                remoteViews.setOnClickPendingIntent(R.id.widget_view, pendingIntent);
            } else {
                Intent activityIntent = new Intent(this, WidgetActivity.class);
